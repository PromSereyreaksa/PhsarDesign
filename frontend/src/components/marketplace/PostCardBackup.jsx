        ...
        >
          ...
          <div className="relative h-48 overflow-hidden">
            ...
            <div className="absolute top-2 left-2">
              <span className="px-2 py-1 bg-black/60 backdrop-blur-sm border border-white/20 rounded-full text-white text-xs font-medium">
          ...
          {/* Content Section - Better proportions for wider cards */}
          <div className="p-4 space-y-3 flex-1 flex flex-col">
            <div className="flex justify-between items-start">
              <h3 className="text-base font-semibold text-white line-clamp-2 flex-1 mr-2">
                {post.title}
              </h3>
              <div className="text-[#A95BAB] font-bold text-sm whitespace-nowrap">
...
export default PostCard                  .split(",")
                  .slice(0, 3)
                  .map((skill, index) => (
                    <span
                      key={index}
                      className="px-2 py-0.5 bg-white/10 rounded-full text-xs text-gray-300 border border-white/20"
                    >
                      {skill.trim()}
                    </span>
                  ))}
            ...
            <div className="flex gap-2 mt-3">
              <button
                onClick={handleApplication}
                className={`w-full flex items-center justify-center space-x-2 py-2.5 rounded-lg font-medium text-sm transition-all duration-300 cursor-pointer ${
                  isJobPost
                    ? "bg-gradient-to-r from-[#A95BAB] to-[#A95BAB]/80 text-white hover:shadow-lg hover:shadow-[#A95BAB]/20"
                    : "bg-gradient-to-r from-blue-500 to-blue-600 text-white hover:shadow-lg hover:shadow-blue-500/20"
                }`}
