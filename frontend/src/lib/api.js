...
export const applicationsAPI = {
  ...
  getReceived: (params) => api.get('/api/applications/received', { params }),
  getSent: (params) => api.get('/api/applications/sent', { params }),
  create: (applicationData) => api.post('/api/applications', applicationData),
  applyToJob: (applicationData) => api.post('/api/applications/job', applicationData),
