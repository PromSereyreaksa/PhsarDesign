  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#202020] to-[#000000] relative">
      ...
      <div className="pt-20">
        ...
        <ExploreSection isExpanded={false} onToggle={scrollToFreelancing} />
        {/* All sections visible by default */}
        <FreelancingOpportunitiesSection titleRef={freelancingRef} customImages={["/image/freelance1.png","/image/freelance2.png","/image/freelance3.png","/image/freelance4.png","/image/freelance5.png","/image/freelance6.png",]} />
        <PopularServicesSection customImages={["/image/Service1.jpg","/image/Service2.jpg","/image/Service3.jpg","/image/Service4.jpg",]} />
        <ArtistsSection customImages={["/image/Artist1.jpg","/image/Artist2.jpg","/image/Artist3.jpg","/image/Artist4.jpg","/image/Artist5.jpg",]} />
        <FooterSection />
      </div>
    </div>
  )
